...
def main(
    ...
    if use_dimacs:
        ...
        dimacs_to_kbann_rules(mapping, input_filename, rule_file_path) # Load rules directly from the hardcoded DIMACS file
...
def dimacs_to_kbann_rules(variable_mapping, input_filename, output_filename):
